...
"""
                ...
                echo "Warning: Standard pairs file exists; skipping \"Step #3: Run pairtools parse2\""
...
"""
                ...
                echo "Warning: rDNA pairs file exists; skipping \"Step #3: Run pairtools parse2\""
        done
    } ||
    {
...
"""
                ...
                echo "Sorted standard pairs file exists; skipping \"Step #4: Run pairtools sort\""
...
"""
                ...
                echo "Sorted rDNA pairs file exists; skipping \"Step #4: Run pairtools sort\""
        done
    } ||
    {
            ...
            [[ -f "${a_sort_std[${i}]}" && ! -f "${a_dedup_pre_pairs_std[${i}]}" ]] &&
                {
                    ...
                    pairtools dedup \\
                        ...
                        --output-dups \\
                            >(
                                pairtools split \\
                                    --output-pairs \"${a_dedup_pre_pairs_std[${i}]%.nodups.pairs.gz}.dups.pairs.gz\"
                            )
            ...
            [[ -f "${a_sort_rDNA[${i}]}" && ! -f "${a_dedup_pre_pairs_rDNA[${i}]}" ]] &&
                {
                    ...
                    pairtools dedup \\
                        ...
                        --output-dups \\
                            >(
                                pairtools split \\
                                    --output-pairs \"${a_dedup_pre_pairs_rDNA[${i}]%.nodups.pairs.gz}.dups.pairs.gz\"
                            )
                        --output-stats \"${a_dedup_stats[${i}]}\" \\
                        \"${a_sort_rDNA[${i}]}\"
                    EOF
